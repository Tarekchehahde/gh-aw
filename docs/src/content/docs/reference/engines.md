...
| `COPILOT_PROVIDER_WIRE_API` | Optional | Wire API variant: `completions` (default), `responses` (for GPT-5 reasoning/o-series), or `messages` (for GPT-5-mini class models) |
